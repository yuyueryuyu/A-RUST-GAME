...
const PARAMETERS_INITIALS: [(&str, ValueType); 9] = [
    ...
    ("is_running", ValueType::Boolean(false)),
    ("is_facing_right", ValueType::Boolean(true)),
    ("is_crouching", ValueType::Boolean(false)),
    ("is_grounded", ValueType::Boolean(true)),
    ("velocity_y", ValueType::Float(0.0)),
    ("is_on_wall", ValueType::Boolean(false)),
    ("is_on_ceiling", ValueType::Boolean(false)),
    ("shift_press_time", ValueType::Float(0.0)),
];
